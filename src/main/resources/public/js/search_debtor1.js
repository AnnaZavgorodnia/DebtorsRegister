...
function setPhysicalEntities(fullname, birthday, identification_code, chargeback_category) {
    ...
    let dataArray = [
        ...
        },
        {
            ...
            "executive_document_receiver": "господарський суд Господарський суд Одеської області , суддя Демешин О.А.",
...
function setLegalEntities(fullname, identification_code, chargeback_category) {
    //TODO
    ...
    let testData = "[\n" +
        ...
        "            \"executive_document_receiver\": \"комісія по трудових спорах Комісія по трудових спорах АТ \\\"Завод \\\"Маяк\\\"\",\n" +
